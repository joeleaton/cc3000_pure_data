...
// Check the PIN connections. These differ from standard CC3000 examples
// for this to work you need to make changes to cc3000.h and cc3000.cpp. instructions are here http://forums.adafruit.com/viewtopic.php?f=31&t=47004 and saved as a file in the Arduino directory
// need to convert IP to reverse hex for static IP stuff. do it here http://www.adman.net/cisco/hexip.asp
// works assisning a static IP to port 8888. Pure data can then send data via UDP
// for DHCP convert the addresses all to 

// this sketch is adapted from the sketch by mortonkopf on the pjrc forum.
